                ...
                <div className="flex items-center space-x-2">
                    ...
                    />
                     <button 
                        ...
                        className="bg-yellow-100 dark:bg-yellow-800 text-yellow-700 dark:text-yellow-200 px-3 py-2 rounded-md font-bold text-sm hover:bg-yellow-200 dark:hover:bg-yellow-700"
                        title="Copy"
                    >
                        Copy
                    </button>
