...
const RECEIPT_SETTINGS_KEY = "customerReceiptSettings";
const DEFAULT_LOGO = "/gallery/logo.png";

const CustomerReceiptSettings: React.FC = () => {
  const [settings, setSettings] = useLocalStorage(RECEIPT_SETTINGS_KEY, {
  ...
  const handleSave = () => {
    // useLocalStorage handles saving automatically on state change
    alert("Customer receipt settings saved!");
  };
  ...
  return (
    <Card>
      ...
      <p className="text-slate-400 mb-6">
        Customize the receipt that is printed for customers. Ensure tax and
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-6">
          <div>
            ...
            <div className="flex items-center space-x-4">
              <img
                src={logoPreview}
                alt="Logo Preview"
                className="w-20 h-20 rounded-lg bg-slate-200 dark:bg-slate-700 object-cover"
              />
              <input
                type="file"
                accept="image/*"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="taxName" className={labelStyles}>
                Tax Name
              </label>
              <input
                type="text"
          ...
          <div>
            <label htmlFor="registrationNumber" className={labelStyles}>
        ...
        <div className="space-y-6">
          <div>
            <label htmlFor="thankYouMessage" className={labelStyles}>
              Thank You Message
            </label>
            <textarea
              id="thankYouMessage"
          ...
          <div>
            <label htmlFor="loginInstructions" className={labelStyles}>
              Login Instructions
            </label>
            <textarea
          ...
          <div>
            <label htmlFor="galleryUrl" className={labelStyles}>
          ...
          <div>
            <label htmlFor="footerText" className={labelStyles}>
              Footer Text
            </label>
            <input
              type="text"
