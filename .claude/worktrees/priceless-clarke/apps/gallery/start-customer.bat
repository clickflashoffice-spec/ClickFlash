...
REM ============================================================================
REM Customer Portal Startup Script
REM Starts both backend and frontend servers for the Customer Portal
REM ============================================================================

set "APP_NAME=Customer Portal"
set "BACKEND_PORT=8092"
...
if not exist "package.json" (
    ...
    echo [ERROR] Expected location: apps\customer\
    echo.
    pause
    exit /b 1
)
...
start "Customer Backend - Port %BACKEND_PORT%" cmd /k "title Customer Backend && npm start"
if %ERRORLEVEL% NEQ 0 (
...
start "Customer Frontend - Port %FRONTEND_PORT%" cmd /k "title Customer Frontend && npm run dev"
if %ERRORLEVEL% NEQ 0 (
...
echo   - Customer Backend (port %BACKEND_PORT%)
echo   - Customer Frontend (port %FRONTEND_PORT%)
echo.
