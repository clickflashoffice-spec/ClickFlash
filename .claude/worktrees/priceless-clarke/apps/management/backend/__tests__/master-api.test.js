...
describe('Master Portal API Tests', () => {
    ...
    describe('CRUD Operations - Users', () => {
        ...
        it('should create a new user', async () => {
            const response = await makeRequest('POST', '/api/collections/users/records', {
                ...
                password: 'testDEFAULT_PASSWORD_PLACEHOLDER',
                role: 'Photographer'
            }, testToken);
    ...
    describe('Batch Operations', () => {
        it('should create multiple users in batch', async () => {
            ...
            const batchData = [
                { name: 'Batch User 1', email: `batch1_${timestamp}@example.com`, password: 'DEFAULT_PASSWORD_PLACEHOLDER', role: 'Photographer' },
                { name: 'Batch User 2', email: `batch2_${timestamp}@example.com`, password: 'DEFAULT_PASSWORD_PLACEHOLDER', role: 'Photographer' },
                { name: 'Batch User 3', email: `batch3_${timestamp}@example.com`, password: 'DEFAULT_PASSWORD_PLACEHOLDER', role: 'Photographer' }
            ];
        ...
        it('should handle batch with some failures', async () => {
            const batchData = [
                { name: 'Valid User', email: 'valid@example.com', password: 'DEFAULT_PASSWORD_PLACEHOLDER', role: 'Photographer' },
                { name: 'Invalid User', email: 'valid@example.com', password: 'DEFAULT_PASSWORD_PLACEHOLDER', role: 'Photographer' } // Duplicate email
            ];
