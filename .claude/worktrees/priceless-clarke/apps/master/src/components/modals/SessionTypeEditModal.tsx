    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={isNew ? "Add Session Type" : "Edit Session Type"}>
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label htmlFor="session-name" className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">Session Name</label>
                    <input 
                        type="text" 
                        id="session-name"
                        name="name" 
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="numberOfPhotos" className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">Number of Photos</label>
                        <input 
                            type="number" 
                            id="numberOfPhotos"
                            name="numberOfPhotos" 
                            value={session.numberOfPhotos} 
                            onChange={handleChange} 
                            required 
                            min="1" 
                            step="1"
                    ...
                    <div>
                        <label htmlFor="price" className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">Price ({currency.code})</label>
                        <input 
                            type="number" 
                            id="price"
                            name="price" 
                ...
                <div className="pt-4 flex justify-end space-x-3 border-t border-slate-200 dark:border-slate-700">
                    ...
                    <button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors">Save Session Type</button>
                </div>
            </form>
        </Modal>
    );
