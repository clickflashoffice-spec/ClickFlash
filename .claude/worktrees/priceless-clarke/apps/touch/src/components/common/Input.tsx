...
const Input: React.FC<InputProps> = React.memo(({ 
  ...
  const baseInputClasses = "w-full px-4 py-3 text-lg bg-white dark:bg-slate-800 border rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-0 disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation";
  ...
  const iconPadding = icon ? "pl-12" : iconRight ? "pr-12" : "";
  ...
  return (
    <div className={fullWidth ? "w-full" : ""}>
      ...
      {error && (
        <p 
          id={errorId}
          className="mt-2 text-base text-red-600 dark:text-red-400" 
          role="alert"
        >
          {error}
        </p>
