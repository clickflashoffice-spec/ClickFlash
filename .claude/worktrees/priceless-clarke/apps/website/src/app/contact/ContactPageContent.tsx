            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
                <div className="text-center mb-12 md:mb-16 lg:mb-24">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-serif text-slate-900 mb-6 md:mb-8 uppercase tracking-tighter">
                        Get in <span className="text-cyan-500 font-sans">Touch</span>
                    </h1>
                    <p className="text-slate-500 text-base md:text-lg max-w-2xl mx-auto font-light leading-relaxed px-4">
                        ...
                        <div>
                            ...
                            <div className="space-y-6 md:space-y-8">
                                <a href={`mailto:${contactEmail}`} className="flex items-start gap-6 group">
                                    <div className="w-12 h-12 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-cyan-500 group-hover:text-white transition-all duration-300">
                                        <Mail className="w-5 h-5" />
                                    </div>
                                    <div>
                                        <h3 className="text-sm font-bold uppercase tracking-widest text-slate-900 mb-1">Email Us</h3>
                                        <p className="text-slate-500 text-sm mb-1">{contactEmail}</p>
                                        <p className="text-cyan-500 text-xs font-bold uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0">Send Email →</p>
                                    </div>
                                </a>
                                ...
                                <a href={`tel:${contactPhone}`} className="flex items-start gap-6 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-500 text-sm mb-1">{contactPhone}</p>
                                        <p className="text-cyan-500 text-xs font-bold uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0">Call Now →</p>
                                    </div>
                                </a>
                                ...
                                {contactWhatsapp && (
                                    <a href={`https://wa.me/${contactWhatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="flex items-start gap-6 group">
                                        <div className="w-12 h-12 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-[#25D366] group-hover:text-white transition-all duration-300">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-slate-500 text-sm mb-1">WhatsApp Available</p>
                                ...
                                <div className="flex items-start gap-6 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-500 text-sm mb-1 whitespace-pre-line">{contactAddress}</p>
                                        <p className="text-cyan-500 text-xs font-bold uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0">View Map →</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="text-[11px] font-black uppercase tracking-widest text-slate-400">Your Name</label>
                                    <input
                                        type="text"
                                        required
                                        value={formData.name}
                            ...
                            {status === "success" && (
                                <div className="p-4 bg-green-50 text-green-600 rounded-xl text-sm font-medium animate-in fade-in">
                            ...
                            <button
                                type="submit"
                                disabled={isSubmitting}
                                className="w-full bg-slate-900 text-white py-5 rounded-2xl font-black uppercase tracking-widest text-[12px] hover:bg-cyan-500 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 disabled:hover:bg-slate-900 disabled:hover:scale-100"
                            >
