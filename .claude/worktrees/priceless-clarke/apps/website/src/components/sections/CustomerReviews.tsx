  ...
  return (
    <section className="relative overflow-hidden bg-slate-50 py-16 md:py-24 lg:py-32">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="mb-4 block text-[11px] md:text-[13px] font-bold tracking-[0.4em] text-cyan-500 uppercase">
            Customer Experience
          </span>
          <h2 className="mb-6 md:mb-8 text-3xl sm:text-4xl leading-tight font-black tracking-tighter text-slate-900 md:text-5xl lg:text-6xl">
