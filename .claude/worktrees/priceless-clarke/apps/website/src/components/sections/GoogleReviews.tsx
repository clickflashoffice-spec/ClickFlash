            ...
            <div className="container mx-auto px-6 max-w-5xl mb-12">
                <div className="flex flex-col md:flex-row justify-between items-center bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
                    <div className="flex items-center gap-4">
                        <span className="font-black text-slate-800 text-xl">Excellent</span>
            ...
            <div className="container mx-auto px-6 relative z-10 group">
                ...
                >
                    {googleReviews.map((review, i) => (
                        <motion.div
                            key={i}
                            className="min-w-full md:min-w-[calc(33.33%-22px)] snap-start bg-white p-12 rounded-[50px] border border-slate-100 hover:shadow-2xl hover:border-cyan-100 transition-all duration-500 flex flex-col shadow-xl"
                        >
                            ...
                            <p className="text-[17px] leading-[1.6] text-slate-600 mb-10 font-medium italic">
                                &ldquo;{review.text}&rdquo;
                            </p>

                            <div className="mt-auto flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center font-black text-slate-800 text-lg">
                                ...
                                <div className="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center border border-slate-100 text-blue-500 font-black text-xs">
                                    G
                                </div>
                            </div>
                        </motion.div>
