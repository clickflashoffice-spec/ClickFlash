...
-- NOTE: photographerId column may not exist yet in early migrations
...
-- Skip photographerId if column doesn't exist yet
...
-- CREATE INDEX IF NOT EXISTS idx_orders_photographerId ON orders(photographerId); -- Column may not exist
...
-- CREATE INDEX IF NOT EXISTS idx_albums_photographer_status ON albums(photographerId, status); -- photographerId may not exist
