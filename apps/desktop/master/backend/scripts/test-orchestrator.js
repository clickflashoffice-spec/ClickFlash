...
function runTests() {
    return __awaiter(this, void 0, void 0, function () {
        var mockWebhookPayload, response, text, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 6, , 7]);
                    return [4 /*yield*/, fetch('http://localhost:8090/webhook/whatsapp', {
                            method: 'POST',
                            headers: {
                ...
                case 6:
                    e_1 = _a.sent();
                    console.log('Error delivering webhook. Make sure the server is running on port 8090:', e_1.message);
                    return [3 /*break*/, 7];
                case 7:
                    console.log('\n--- Tests Finished ---');
                    return [2 /*return*/];
