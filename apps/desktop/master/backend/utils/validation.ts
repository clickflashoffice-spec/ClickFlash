...
export const userSchema = z.object({
    ...
    avatarUrl: z.string().optional().nullable().refine(
    ...
    dailyPhotoTarget: z.number().min(0).optional().nullable(),
...
export const albumSchema = z.object({
    ...
    photographerId: z.union([z.number(), z.string(), z.null()]).optional().nullable(),
    roomNumber: z.union([z.string(), z.number()]).transform(val => String(val)).optional().nullable().or(z.literal('')),
    source: z.string().max(100, 'Source is too long').optional().nullable(),
    eventType: z.string().max(100, 'Event type is too long').optional().nullable(),
    status: z.enum(['Draft', 'Finalized', 'Archived']).optional().nullable(),
    categories: z.union([z.array(z.string()), z.string()]).optional().nullable(),
    customerEmail: z.string().optional().nullable().or(z.literal('')),
    coverPhotoUrl: z.string().max(500, 'Cover photo URL is too long').optional().nullable(),
    ...commonFields
});
...
export const photoSchema = z.object({
    ...
    roomNumber: z.union([z.string(), z.number()]).transform(val => String(val)).optional().nullable(),
    ...
    tinyUrl: z.string().optional().nullable(),
    previewUrl: z.string().optional().nullable(),
    sync_status: z.string().optional().nullable(),
    sync_id: z.string().optional().nullable(),
    quality_flags: z.string().optional().nullable(),
