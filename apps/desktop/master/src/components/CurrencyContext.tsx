...
import { AVAILABLE_CURRENCIES, BASE_CURRENCY } from '../constants';
...
export const CurrencyProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  const [currencyCode, setCurrencyCode] = useState<string>(() => {
    return safeStorage.getItem('currencyCode') || BASE_CURRENCY.code;
  });
  ...
  useEffect(() => {
    safeStorage.setItem('currencyCode', currency.code);
  }, [currency]);
