      ...
      try {
        ...
        const uploadPhotoWithRetry = async (
          ...
          try {
            ...
            if (albumData.photographerId !== undefined && albumData.photographerId !== null && String(albumData.photographerId) !== "undefined" && String(albumData.photographerId) !== "null" && String(albumData.photographerId) !== "") {
