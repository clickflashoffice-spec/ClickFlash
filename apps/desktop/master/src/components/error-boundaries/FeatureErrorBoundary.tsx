...
export class FeatureErrorBoundary extends Component<Props, State> {
    ...
    componentDidCatch(error: Error, errorInfo: ErrorInfo) {
        const { feature, severity = 'medium', onError } = (this as any).props;
    ...
    handleReset = () => {
        const { onReset } = (this as any).props;
    ...
    render() {
        ...
        const { children, feature, severity = 'medium', fallback } = (this as any).props;
