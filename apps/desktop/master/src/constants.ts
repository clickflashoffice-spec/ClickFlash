...
import {
    ...
    Product, Pack, Currency, FileSystemItem, SessionType, Booking,
    Destination, Expense, Loan, Adjustment, Equipment, ExpenseCategory, EquipmentCategory, OrderItem, WorkingHours
} from './types';

// --- CONFIGURATION CONSTANTS ---
export const DEFAULT_MASTER_PORT = 8090;  // Master backend port
export const DEFAULT_TOUCH_PORT = 8091;   // Touch backend port
export const DEFAULT_MASTER_HOST = '127.0.0.1';
export const DEFAULT_MASTER_BASE_URL = `http://${DEFAULT_MASTER_HOST}:${DEFAULT_MASTER_PORT}`;
...
export const AVAILABLE_CURRENCIES: Currency[] = [
    { id: 'eur', code: 'EUR', name: 'Euro', symbol: '€', rate: 1 },
...
export const BASE_CURRENCY = AVAILABLE_CURRENCIES[0];
...
export const MOCK_PRINT_SIZES = [
    { size: 'Digital Copy', price: 15 },
    { size: '10x15cm Print', price: 10 },
    { size: '13x18cm Print', price: 15 },
    { size: '20x30cm Print', price: 25 },
    { size: 'A4 Framed Print', price: 50 },
    { size: 'Magnet', price: 8 },
];
...
export const MOCK_ADJUSTMENTS: Adjustment[] = [
    { id: 'adj1', date: '2025-10-01', photographerId: '2', amount: 250, description: 'Top performer bonus', type: 'Bonus', status: 'Paid' },
