        ...
        <div className="flex-1 flex flex-col items-center justify-center p-10 text-center">
          ...
          <div className="flex items-center gap-3 mb-6">
            <button
              ...
              className="px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/20 rounded-lg text-sm text-white/90 transition-colors flex items-center gap-2"
            >
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="px-6 py-4 border-t border-white/10 bg-[#131C31]/30 rounded-b-2xl">
            ...
            <div className="flex justify-center gap-3 mt-3">
              <button
                onClick={(e) => { e.stopPropagation(); handleNativeFileSelect(); }}
                className="px-3 py-1.5 bg-white/5 hover:bg-white/10 rounded text-xs text-white/70 transition-colors flex items-center gap-1.5"
              >
