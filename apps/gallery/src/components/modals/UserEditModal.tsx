    ...
    <Modal isOpen={isOpen} onClose={onClose} title={isNewUser ? "Add New User" : "Edit User"}>
      <form onSubmit={handleSubmit} className="space-y-4">
         ...
         <div>
            ...
            <input type="text" name="name" value={user.name} onChange={handleChange} required autoComplete="name" className={inputStyles} />
        </div>
         <div>
            <label htmlFor="email" className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">Email Address</label>
            <input type="email" name="email" value={user.email} onChange={handleChange} required autoComplete="email" className={inputStyles} />
        </div>
        <div className="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="specialty" value={user.specialty} onChange={handleChange} required autoComplete="off" className={inputStyles} />
            </div>
            <div>
                <label htmlFor="role" className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">Role</label>
                <select name="role" value={user.role} onChange={handleChange} required className={inputStyles}>
        ...
        <div>
            ...
            <input type="number" name="monthlyTarget" value={displayTarget.toFixed(0)} onChange={handleChange} autoComplete="off" className={inputStyles} />
        </div>
        ...
        {isNewUser ? (
             <div>
                ...
                <input type="password" name="password" value={password} onChange={(e) => setPassword(e.target.value)} required autoComplete="new-password" className={inputStyles} />
            </div>
        ) : (
