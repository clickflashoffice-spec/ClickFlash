...
const SelectionCartBar: React.FC<SelectionCartBarProps> = ({ onShowCart, count }) => {
    return (
        <button onClick={onShowCart} className="w-24 h-24 bg-white dark:bg-slate-800 rounded-full shadow-lg flex flex-col items-center justify-center border-4 border-slate-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-500 transition-colors relative">
