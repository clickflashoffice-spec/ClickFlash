 ...
 * 
 * Comprehensive error boundary system for the Management App.
...
export const ManagementErrorBoundary: React.FC<{ children: ReactNode }> = ({ children }) => (
    <FeatureErrorBoundary feature="Management" severity="high">
        {children}
    </FeatureErrorBoundary>
);

export const BookingErrorBoundary: React.FC<{ children: ReactNode }> = ({ children }) => (
    <FeatureErrorBoundary feature="Booking Management" severity="medium">
        {children}
    </FeatureErrorBoundary>
);

export const CustomerErrorBoundary: React.FC<{ children: ReactNode }> = ({ children }) => (
    <FeatureErrorBoundary feature="Customer Portal" severity="medium">
        {children}
    </FeatureErrorBoundary>
);

export const ProductErrorBoundary: React.FC<{ children: ReactNode }> = ({ children }) => (
    <FeatureErrorBoundary feature="Product Management" severity="medium">
        {children}
    </FeatureErrorBoundary>
);
