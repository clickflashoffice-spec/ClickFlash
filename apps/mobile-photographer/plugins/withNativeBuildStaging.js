...
subprojects { subproject ->
  if (subproject.name in ["expo-modules-core", "react-native-reanimated", "react-native-worklets"]) {
...
module.exports = createRunOncePlugin(withNativeBuildStaging, PLUGIN_NAME, '1.0.0');
