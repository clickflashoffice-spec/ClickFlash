# Mobile Photographer App Override Rules

> **Target**: `apps/mobile-photographer` (Expo React Native, Android D7000 Tether)
...
- **Platform**: Android ONLY. Stable package identity `com.clickflash.photographer`. Requires API 26+.
