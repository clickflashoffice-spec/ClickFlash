...
export function VirtualGrid<T>({
    ...
    // Ensure FixedSizeGrid component is available
    if (!FixedSizeGrid || typeof FixedSizeGrid !== 'function') {
        return null;
    }
    ...
    let finalColumnWidth = 0;
    let finalHeight = 0;
    let finalRowCount = 0;
    let finalRowHeight = 0;
    let finalWidth = 0;
    let finalOverscanRowCount = 0;
    let finalOverscanColumnCount = 0;
    ...
    try {
        ...
        finalColumnCount = Number(cleanProps.columnCount);
        finalColumnWidth = Number(cleanProps.columnWidth);
        finalHeight = Number(cleanProps.height);
        finalRowCount = Number(cleanProps.rowCount);
        finalRowHeight = Number(cleanProps.rowHeight);
        finalWidth = Number(cleanProps.width);
        finalOverscanRowCount = Number(cleanProps.overscanRowCount);
        finalOverscanColumnCount = Number(cleanProps.overscanColumnCount);
