...
// Standard Master Categories: 'Beach & Pool', 'Photo Session', 'Evening', 'Activities', 'Restaurant'
...
export interface Order {
    ...
    // Order source: 'kiosk' for orders from Touch Kiosk tablets, 'manual' for orders created by staff in Master Portal
    source?: 'kiosk' | 'manual';
    updatedAt?: string;
}
...
export type EquipmentStatus = 'Available' | 'In Use' | 'In Storage' | 'Needs Repair' | 'Retired';
