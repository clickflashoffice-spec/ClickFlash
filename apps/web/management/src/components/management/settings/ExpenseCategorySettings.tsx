...
const ExpenseCategorySettings: React.FC = () => {
  ...
  const [categoryToEdit, setCategoryToEdit] = useState<ExpenseCategory | null>(
    null,
  );
  ...
  const handleSave = async (
    category: Omit<ExpenseCategory, "id"> | ExpenseCategory,
  ) => {
    if ("id" in category) {
  ...
  return (
    <div>
      ...
      <p className="text-slate-500 dark:text-slate-400 mb-6">
        These categories are used across all destinations for tracking expenses.
      </p>
