import { moneyTrashEmailMarketing } from '../../src/services/moneyTrashEmailMarketing';
...
describe('MoneyTrashEmailMarketingService', () => {
  beforeEach(() => {
    ...
    // We need to re-initialize the service if we want fresh state, 
    // or access private members for mock injections. Since it's a singleton, 
    // we'll inject fake logs for testing rightToBeForgotten.
  });
