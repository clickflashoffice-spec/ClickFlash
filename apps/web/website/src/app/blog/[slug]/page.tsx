    ...
    return (
        <article className="min-h-screen bg-white pt-24 md:pt-28 lg:pt-32 pb-16 md:pb-24">
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-10 p-6 md:p-8 bg-slate-50 rounded-2xl">
                    <div className="flex items-start gap-4">
                        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-slate-900 text-xl font-medium shrink-0">
                            {post.author.split(' ').map(n => n[0]).join('')}
                        </div>
                        <div>
            ...
            <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 md:mt-24">
                <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-8 md:p-12 rounded-2xl text-center text-slate-900">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link
                            href="/portfolio"
                            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-slate-100 text-white font-medium rounded-full hover:bg-slate-200 transition-all"
                        >
                            View Portfolio
                        </Link>
                    </div>
