...
export default async function BlogPostPage({ params }: Props) {
    ...
    return (
        <article className="min-h-screen bg-[#0B111F] pt-24 md:pt-28 lg:pt-32 pb-16 md:pb-24">
            ...
            <header className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 md:mb-12">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light text-white mb-6 md:mb-8 tracking-tight leading-tight">
                    {post.title}
                </h1>
                ...
                <div className="flex items-center gap-4 text-sm text-white/70">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <span className="font-medium text-white block">{post.author}</span>
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-10 md:mb-16">
                <div className="aspect-[16/9] md:aspect-[21/9] relative overflow-hidden bg-white/10 rounded-xl md:rounded-2xl">
                    <NextImage
                        src={post.image}
                        alt={post.title}
                        fill
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <div 
                    ...
                    prose-h2:text-xl md:prose-h2:text-2xl prose-h2:mt-10 md:prose-h2:mt-12 prose-h2:mb-4 md:prose-h2:mb-6 prose-h2:pb-3 prose-h2:border-b prose-h2:border-white/10
                    prose-h3:text-lg md:prose-h3:text-xl prose-h3:mt-8 md:prose-h3:mt-10 prose-h3:mb-3 md:prose-h3:mb-4
                    prose-ul:my-6 prose-li:my-2 prose-li:text-white/70
                    prose-blockquote:border-l-cyan-500 prose-blockquote:bg-white/5 prose-blockquote:py-2 prose-blockquote:px-4 prose-blockquote:rounded-r-lg"
                ...
                <div className="mt-10 pt-6 border-t border-white/10">
                    <div className="flex flex-wrap items-center gap-2">
                        <span className="text-sm text-white/70 mr-2">Tags:</span>
                        {post.tags.map(tag => (
                            <span 
                                key={tag} 
                                className="px-3 py-1.5 bg-white/5 text-white/70 text-xs font-medium rounded-full hover:bg-cyan-50 hover:text-cyan-700 transition-colors cursor-pointer"
                            >
                                {tag}
                            </span>
                        ))}
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                        <div className="flex items-center gap-3">
                            ...
                            <a 
                                ...
                                className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 text-white/70 hover:bg-cyan-50 hover:text-cyan-700 transition-all"
                            >
                            ...
                            <a 
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 text-white/70 hover:bg-blue-50 hover:text-blue-600 transition-all"
                            >
                            ...
                            <a 
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 text-white/70 hover:bg-blue-50 hover:text-blue-700 transition-all"
                            >
                ...
                {/* Author Box */}
                <div className="mt-10 p-6 md:p-8 bg-white/5 rounded-2xl">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="font-medium text-white mb-1">About {post.author}</h3>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        {relatedPosts.map((relatedPost) => (
                            <Link
                                ...
                                className="group flex flex-col bg-[#0B111F] overflow-hidden"
                            >
                                <div className="aspect-[4/3] relative overflow-hidden bg-white/10 mb-4 rounded-xl">
                                    <NextImage
                                ...
                                <h3 className="text-lg font-medium text-white group-hover:text-cyan-700 transition-colors leading-snug">
                                    {relatedPost.title}
                                </h3>
                            </Link>
                        ))}
            ...
            <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 md:mt-24">
                <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-8 md:p-12 rounded-2xl text-center text-white">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link
                            href="/portfolio"
                            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#0B111F]/10 text-white font-medium rounded-full hover:bg-[#0B111F]/20 transition-all"
                        >
                            View Portfolio
                        </Link>
                    </div>
