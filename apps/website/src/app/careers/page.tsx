        ...
        <main className="min-h-screen bg-white pt-32 pb-24">
            <div className="container mx-auto px-6">
                <div className="max-w-4xl">
                    ...
                    <p className="text-2xl text-slate-500 font-bold mb-16 max-w-2xl leading-tight">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div className="space-y-6">
                            <h2 className="text-xl font-black uppercase tracking-widest text-slate-400">Why ClickFlash?</h2>
                            ...
                            <ul className="space-y-4">
                                {['Resort Photographer', 'Quality Editor', 'Operations Manager'].map(role => (
                                    <li key={role} className="flex items-center justify-between group cursor-pointer border-b border-slate-200 pb-3">
                                        <span className="font-bold text-slate-700 group-hover:text-cyan-500 transition-colors uppercase tracking-tight">{role}</span>
                                        <span className="text-[10px] font-black bg-cyan-100 text-cyan-600 px-2 py-1 rounded uppercase tracking-widest">Apply</span>
                                    </li>
                                ))}
                            </ul>
                        </div>
            ...
            {/* INSTAGRAM FEED */}
            <InstagramFeed
                title={<>Behind the <span className="text-cyan-500">Scenes</span></>}
