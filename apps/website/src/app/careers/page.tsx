        ...
        <main className="min-h-screen bg-[#0B111F] pt-32 pb-24">
            <div className="container mx-auto px-6">
                <div className="max-w-4xl">
                    <h1 className="text-6xl md:text-8xl font-black mb-12 text-white uppercase tracking-tighter leading-none">
                        Join Our <span className="text-cyan-700">Team</span>
                    </h1>
                    <p className="text-2xl text-white/70 font-bold mb-16 max-w-2xl leading-tight">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div className="space-y-6">
                            <h2 className="text-xl font-black uppercase tracking-widest text-white/70">Why ClickFlash?</h2>
                        ...
                        <div className="bg-white/5 p-12 rounded-[2.5rem] border border-white/10 shadow-xl">
                            <h3 className="text-xl font-black text-white mb-4 uppercase">Open Roles</h3>
                            <ul className="space-y-4">
                                {['Resort Photographer', 'Quality Editor', 'Operations Manager'].map(role => (
                                    <li key={role} className="flex items-center justify-between group cursor-pointer border-b border-white/20 pb-3">
