  ...
  return (
    <main className="min-h-screen bg-[#0B111F] pt-32 pb-24">
      <div className="container mx-auto px-6 max-w-4xl">
        <h1 className="text-6xl md:text-7xl font-serif text-white mb-12 uppercase tracking-tighter">
          Terms of <span className="text-cyan-700">Service</span>
        </h1>
        <div className="prose prose-slate max-w-none prose-headings:font-serif prose-headings:uppercase prose-headings:tracking-tight prose-a:text-cyan-700 prose-a:no-underline hover:prose-a:underline">
          <p className="text-white/70 mb-12 font-bold uppercase tracking-widest text-[10px] pb-8 border-b border-slate-50">Last updated: February 1, 2026</p>

          <section className="mb-12">
            <h2 className="text-3xl text-white mb-6 font-serif uppercase tracking-tight">1. Agreement to Terms</h2>
          ...
          <section className="mb-12">
            <h2 className="text-3xl text-white mb-6 font-serif uppercase tracking-tight">2. Services</h2>
            <p className="text-white/70 leading-relaxed font-medium">
          ...
          <section className="mb-12">
            <h2 className="text-3xl text-white mb-6 font-serif uppercase tracking-tight">3. Booking and Cancellation</h2>
            ...
            <ul className="text-white/70 list-disc pl-6 space-y-3 font-medium">
          ...
          <section className="mb-12">
            <h2 className="text-3xl text-white mb-6 font-serif uppercase tracking-tight">4. Intellectual Property</h2>
            <p className="text-white/70 leading-relaxed font-medium">
          ...
          <section className="mt-20 p-10 bg-white/5 rounded-[2.5rem] border border-white/10">
            <h2 className="text-2xl text-white mb-6 font-serif uppercase tracking-tight">5. Contact</h2>
            <p className="text-white/70 font-medium">
              For questions about these Terms, please contact our legal team at:
              <br />
              <a href="mailto:legal@clickflash.photography" className="inline-block mt-4 text-cyan-700 font-bold">
