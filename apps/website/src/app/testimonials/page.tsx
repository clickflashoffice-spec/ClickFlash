            ...
            <section className="max-w-7xl mx-auto px-6">
                <div className="bg-slate-50 border border-slate-100 rounded-[4rem] p-16 md:p-24 text-center relative overflow-hidden shadow-sm">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center relative z-10">
                        ...
                        <Link
                            href="/portfolio"
                            className="bg-white text-white border border-slate-200 font-black uppercase py-6 px-14 rounded-full hover:bg-slate-50 transition-all text-[11px] tracking-widest"
                        >
                            View Portfolio
                        </Link>
                    </div>
