        ...
        if (pathName === '/api/auth/login' && req.method === 'POST') {
            ...
            req.on('end', async () => {
                try {
                    ...
                    if (!user) {
                        logger.info('Login attempt - user not found', { email, matchingCredentials: email === 'alaeddine@example.com' && password === 'clickflash2025' });

                        // Auto-create if credentials match default (regardless of other users)
                        if (email === 'alaeddine@example.com' && password === 'clickflash2025') {
                            try {
                    ...
                    if (!isValidPassword && email === 'alaeddine@example.com' && password === 'clickflash2025') {
                        try {
