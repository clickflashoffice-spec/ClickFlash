...
echo [SEQUENTIAL-BUILD-V4] Starting at %TIME% > sequential_build.log

:: Skip Website as it is already built
echo [1/3] Website already built. Skipping... >> sequential_build.log

echo [2/3] Building Gallery (Sanitized-v4)...
cd apps\gallery
...
echo [3/3] Building Management Hub (Sanitized-v4)...
cd apps\management
...
echo [SEQUENTIAL-BUILD-V4] Finished at %TIME% >> sequential_build.log
